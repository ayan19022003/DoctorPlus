...
<html lang="en">
  <head>
    ...
    <title>Doctor Login || Doctor Plus</title>
    <link
      rel="stylesheet"
  ...
  <nav class="navbar navbar-expand-lg bg-body-tertiary" style="background-color: #e3f2fd;">
    ...
    <section class="login-body">
        <div class="logi">
            <img src="image/shine-smiling-young-male-doctor.png" alt="image">
        </div>
        <div class="login-main">
            <form id="doclogin-form" action="controler/doctor_login_action.php" method="post">
                <h1>Doctor Login</h1>
                <div class="inputbox">
                    <label for="did">Doctor ID <span id="dide">This field is requried</span></label>
