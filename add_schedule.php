...
<html lang="en">
  <head>
    ...
    <title>Add Schedule || Doctor Plus</title>
    <link
      rel="stylesheet"
  ...
  <nav class="navbar navbar-expand-lg bg-body-tertiary" style="background-color: #e3f2fd;">
    ...
    <section class="login-body">
      ...
      <div class="login-main">
        <form id="sche-form" action="controler/add_schedule_action.php" method="post">
          <h1>Add Schedule</h1>
        ...
        ?>
            ...
            <input type="submit" value="Submit Request" name="add_schedule" />
        </form>
      </div>
    </section>
    <footer>
