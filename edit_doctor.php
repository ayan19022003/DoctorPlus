...
<html lang="en">
  <head>
    ...
    <title>Edit Doctor || Doctor Plus</title>
    <link
      rel="stylesheet"
  ...
  <nav class="navbar navbar-expand-lg bg-body-tertiary" style="background-color: #e3f2fd;">
    ...
    <section class="login-body">
      <div class="logi" style="flex-direction:column;justify-content:space-between;">
      ...
      <div class="login-main">
        <form id="signup-form" action="controler/signup_action.php" method="post">
          ...
          <div class="inputbox">
            ...
            <div class="inputbox">
            <label for="sy"
                >Phone <span id="phe">This field is requried</span></label
              >
