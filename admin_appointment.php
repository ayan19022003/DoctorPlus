...
<head>
    ...
    <title>Manage Appointment || Doctor Plus</title>
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary" style="background-color: #e3f2fd;">
        <div class="container-fluid">
          ...
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="admin_appointment.php"><i class="las la-calendar-check"></i>&nbsp;Appointment</a>
              </li>
              <li class="nav-item">
      ...
      <section class="appointment-body">
        <h1><i class="las la-calendar-check"></i>&nbsp;Total Appointment List. </h1>
        <div class="abmb shadow">
            ...
            <table class="display appointment-table">
              ...
              <tbody>
              <?php 
                  $query = "SELECT appointment.*,doctor.*,patient.*,schedule.* FROM appointment,doctor,patient,schedule WHERE appointment.sch_id = schedule.sid AND appointment.pet_id= patient.pid AND appointment.doc_id = doctor.did";
                  ...
                  <td><?php
                        $query2 = "SELECT query.*,appointment.*,solution.* FROM query, appointment, solution WHERE solution.qu_id=query.qid AND query.ap_id=appointment.appid AND appointment.appid='".$data['appid']."'";
